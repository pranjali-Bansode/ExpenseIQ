...
description: Runs parallel security and quality code 
  review for a specific ExpenseIQ feature. Pass the spec 
...
**ExpenseIQ-security-reviewer** receives:
...
**ExpenseIQ-quality-reviewer** receives:
- The combined diff from the pre-flight check
- Spec file for context: `.claude/specs/$ARGUMENTS.md`
...
Security Findings
[ExpenseIQ-security-reviewer output]
Quality Findings
[ExpenseIQ-quality-reviewer output]
