---
description: Writes and runs tests for a specific ExpenseIQ feature. Pass the spec name as argument e.g. /test-feature 05-backend-connection
...
Invoke the **expenseiq-test-writer** subagent with the 
following context:
...
Wait for expenseiq-test-writer to fully complete and 
...
Once expenseiq-test-writer has finished, invoke the 
**expenseiq-test-runner** subagent with the following 
context:
...
- If expenseiq-test-writer reports it could not write 
...
**Step 2 — Test Results**
- Mirror the expenseiq-test-runner's structured report
