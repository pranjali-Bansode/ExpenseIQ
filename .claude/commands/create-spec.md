---
description: Create a spec file and feature branch for the next ExpenseIQ step
...
ExpenseIQ expense tracker. Always follow the rules in CLAUDE.md.
...
it exists at this stage of the ExpenseIQ roadmap.
