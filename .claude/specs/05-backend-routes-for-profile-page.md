...
- Response contains the seed user's email ("demo@expenseiq.com")
...
## Definition of done
- [ ] Logging in as the seed user (demo@expenseiq.com / demo123) shows "Demo User" and "demo@expenseiq.com" on the profile page — not the hardcoded strings
